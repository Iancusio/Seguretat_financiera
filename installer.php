...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200511_seguretatfinanciera_fbb565277d4ce7b36086_20200511142240_archive.zip';
	const ARCHIVE_SIZE		 = '23689378';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'fbb5652-11142240';
    const SECONDARY_PACKAGE_HASH = '0b78003-11142240';
